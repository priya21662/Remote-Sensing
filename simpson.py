...
T3=chunks(folder)
simpson_index=simpson(T3)
output=r"C:\Users\supri\OneDrive\Desktop\RS Internship\calc_data\simpson4.bin"
write_polsar_bin(simpson_index,output,folder)
simpson_act=read_bin(r"C:\Users\supri\OneDrive\Desktop\RS Internship\sample_data\full_pol\T3\simpson_index.bin")
diff =simpson_act-simpson_index
path=r"C:\Users\supri\OneDrive\Desktop\RS Internship\calc_data\simpson_diff.bin"
